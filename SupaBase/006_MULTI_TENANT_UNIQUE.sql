...
--
-- Corrección: cada tabla de formularios tiene un UNIQUE compuesto
-- (contrato_id, folio) para que la unicidad sea POR CONTRATO,
-- no global. folio es la clave de upsert en todos los formularios.
--
-- Tablas afectadas:
